...
namespace biblioteca2.Models
{
    ...
    partial void Insertdatos_usuario(datos_usuario instance);
    partial void Updatedatos_usuario(datos_usuario instance);
    partial void Deletedatos_usuario(datos_usuario instance);
    ...
    partial void Deletetutoriale(tutoriale instance);
		...
		public System.Data.Linq.Table<categorizacion> categorizacions
		{
			get
			{
		...
		public System.Data.Linq.Table<datos_usuario> datos_usuarios
		{
			get
			{
				return this.GetTable<datos_usuario>();
			}
		}
    ...
    partial void OnCreated();
    partial void OnidArticulosChanging(int value);
    ...
    partial void OnidPublicacionChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_idArticulos", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
	...
	public partial class aspnet_User : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntitySet<datos_usuario> _datos_usuarios;
    ...
    partial void OnLastActivityDateChanged();
		...
		public aspnet_User()
		{
			...
			this._datos_usuarios = new EntitySet<datos_usuario>(new Action<datos_usuario>(this.attach_datos_usuarios), new Action<datos_usuario>(this.detach_datos_usuarios));
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="aspnet_User_datos_usuario", Storage="_datos_usuarios", ThisKey="UserId", OtherKey="UserId")]
		public EntitySet<datos_usuario> datos_usuarios
		{
			get
			{
				return this._datos_usuarios;
			}
			set
			{
				this._datos_usuarios.Assign(value);
			}
		}
		...
		private void attach_datos_usuarios(datos_usuario entity)
		{
			this.SendPropertyChanging();
			entity.aspnet_User = this;
		}
		
		private void detach_datos_usuarios(datos_usuario entity)
		{
			this.SendPropertyChanging();
			entity.aspnet_User = null;
		}
	...
	public partial class categoria : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntitySet<categorizacion> _categorizacions;
    ...
    partial void OntipoChanged();
		...
		public categoria()
		{
			this._categorizacions = new EntitySet<categorizacion>(new Action<categorizacion>(this.attach_categorizacions), new Action<categorizacion>(this.detach_categorizacions));
			OnCreated();
		}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="categoria_categorizacion", Storage="_categorizacions", ThisKey="idCategoria", OtherKey="idCategoria")]
		public EntitySet<categorizacion> categorizacions
		{
			get
			{
				return this._categorizacions;
			}
			set
			{
				this._categorizacions.Assign(value);
			}
		}
		...
		private void attach_categorizacions(categorizacion entity)
		{
			this.SendPropertyChanging();
			entity.categoria = this;
		}
		
		private void detach_categorizacions(categorizacion entity)
		{
			this.SendPropertyChanging();
			...
			set
			{
							...
							|| (this._categoria.HasLoadedOrAssignedValue == false)))
				{
					...
					if ((previousValue != null))
					{
						...
						previousValue.categorizacions.Remove(this);
					}
					this._categoria.Entity = value;
					if ((value != null))
					{
						value.categorizacions.Add(this);
    ...
    partial void Onvisto_buenoChanging(string value);
    partial void Onvisto_buenoChanged();
    ...
    partial void OnUserIdChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_visto_bueno", DbType="VarChar(10) NOT NULL", CanBeNull=false)]
		public string visto_bueno
		{
			get
			{
				return this._visto_bueno;
			}
			set
			{
				if ((this._visto_bueno != value))
				{
					this.Onvisto_buenoChanging(value);
					this.SendPropertyChanging();
					this._visto_bueno = value;
					this.SendPropertyChanged("visto_bueno");
					this.Onvisto_buenoChanged();
				}
			}
		}
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.datos_usuario")]
	public partial class datos_usuario : INotifyPropertyChanging, INotifyPropertyChanged
	{
		
		private static PropertyChangingEventArgs emptyChangingEventArgs = new PropertyChangingEventArgs(String.Empty);
		
		private int _idDatos_usuario;
    ...
    partial void OnValidate(System.Data.Linq.ChangeAction action);
    partial void OnCreated();
    partial void OnidDatos_usuarioChanging(int value);
    partial void OnidDatos_usuarioChanged();
    partial void OnemailChanging(string value);
    partial void OnemailChanged();
    ...
    partial void OnUserIdChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_idDatos_usuario", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		public int idDatos_usuario
		{
			get
			{
				return this._idDatos_usuario;
			}
			set
			{
				if ((this._idDatos_usuario != value))
				{
					this.OnidDatos_usuarioChanging(value);
					this.SendPropertyChanging();
					this._idDatos_usuario = value;
					this.SendPropertyChanged("idDatos_usuario");
					this.OnidDatos_usuarioChanged();
				}
			}
		}
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_passwor", DbType="VarChar(50) NOT NULL", CanBeNull=false)]
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="aspnet_User_datos_usuario", Storage="_aspnet_User", ThisKey="UserId", OtherKey="UserId", IsForeignKey=true)]
		public aspnet_User aspnet_User
		{
			get
			{
			...
			set
			{
							...
							|| (this._aspnet_User.HasLoadedOrAssignedValue == false)))
				{
					...
					{
						this._aspnet_User.Entity = null;
						previousValue.datos_usuarios.Remove(this);
					}
					this._aspnet_User.Entity = value;
					if ((value != null))
					{
						value.datos_usuarios.Add(this);
						this._UserId = value.UserId;
					}
					else
					{
    ...
    partial void OnidPublicacionChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_portada", DbType="Image NOT NULL", CanBeNull=false, UpdateCheck=UpdateCheck.Never)]
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_indice", DbType="VarChar(100) NOT NULL", CanBeNull=false)]
    ...
    partial void OnUserIdChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="publicacion_categorizacion", Storage="_categorizacions", ThisKey="idPublicacion", OtherKey="idPublicacion")]
		public EntitySet<categorizacion> categorizacions
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="publicacion_tutoriale", Storage="_tutoriales", ThisKey="idPublicacion", OtherKey="idPublicacion")]
    ...
    partial void OnValidate(System.Data.Linq.ChangeAction action);
    partial void OnCreated();
    partial void OnidTutorialesChanging(int value);
    partial void OnidTutorialesChanged();
    partial void OnidPublicacionChanging(int value);
    partial void OnidPublicacionChanged();
    #endregion
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_idTutoriales", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		public int idTutoriales
		{
			get
			{
				return this._idTutoriales;
			}
			set
			{
				if ((this._idTutoriales != value))
				{
					this.OnidTutorialesChanging(value);
					this.SendPropertyChanging();
					this._idTutoriales = value;
					this.SendPropertyChanged("idTutoriales");
					this.OnidTutorialesChanged();
				}
			}
		}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="publicacion_tutoriale", Storage="_publicacion", ThisKey="idPublicacion", OtherKey="idPublicacion", IsForeignKey=true)]
		public publicacion publicacion
		{
			get
			{
